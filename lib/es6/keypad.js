...
exports.GameBoyAdvanceKeypad = void 0;
var GameBoyAdvanceKeypad = /** @class */ (function () {
    ...
    GameBoyAdvanceKeypad.prototype.initKeycodeRemap = function (keyId) {
        // Ensure valid keyId
    ...
    // keyId is ["A", "B", "SELECT", "START", "RIGHT", "LEFT", "UP", "DOWN", "R", "L"]
    GameBoyAdvanceKeypad.prototype.remapKeycode = function (keyId, keycode) {
        switch (keyId) {
            case "A":
...
exports.GameBoyAdvanceKeypad = GameBoyAdvanceKeypad;
