...
exports.ARMCore = void 0;
var arm_1 = require("./arm");
var thumb_1 = require("./thumb");
var ARMCore = /** @class */ (function () {
    function ARMCore() {
        // this.inherit();
        this.SP = 13;
        this.LR = 14;
        ...
        this.armCompiler = new arm_1.ARMCoreArm(this);
        this.thumbCompiler = new thumb_1.ARMCoreThumb(this);
        this.generateConds();
    ...
    ARMCore.prototype.compileArm = function (instruction) {
        ...
        else if (!(instruction & 0x0c000000) &&
            ...
            switch (i) {
                ...
                case 0x06000000:
                    ...
                    var address = function () {
                        throw ("Unimplemented memory access: 0x" +
