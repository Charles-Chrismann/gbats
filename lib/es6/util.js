...
exports.Serializer = exports.Pointer = void 0;
exports.hex = hex;
...
var Serializer = /** @class */ (function () {
    ...
    Serializer.deserialize = function (blob, callback) {
    ...
    Serializer.deserealizeStream = function (view, pointer) {
        pointer.push();
        var object = {};
    ...
    Serializer.serializePNG = function (blob, base, callback) {
    ...
    Serializer.deserializePNG = function (blob, callback) {
        var reader = new FileReader();
        reader.onload = function (data) {
            ...
            var newBlob = new Blob(newData.map(function (byte) {
    ...
    Serializer.TAG_INT = 1;
    Serializer.TAG_STRING = 2;
    Serializer.TAG_STRUCT = 3;
    Serializer.TAG_BLOB = 4;
    Serializer.TAG_BOOLEAN = 5;
