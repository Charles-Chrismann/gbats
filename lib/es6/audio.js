...
exports.GameBoyAdvanceAudio = void 0;
var GameBoyAdvanceAudio = /** @class */ (function () {
            ...
            if (this.enableChannel3 && this.playingChannel3) {
                if (cycles >= this.channel3Next) {
                    if (this.channel3Write) {
                        ...
                        if (this.channel3Dimension &&
                            this.channel3Pointer >= 64) {
                            this.channel3Pointer -= 64;
                        }
                        else if (!this.channel3Bank &&
...
exports.GameBoyAdvanceAudio = GameBoyAdvanceAudio;
