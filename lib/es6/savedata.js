...
exports.EEPROMSavedata = exports.FlashSavedata = exports.SRAMSavedata = exports.MemoryView = void 0;
...
var SRAMSavedata = /** @class */ (function (_super) {
...
var FlashSavedata = /** @class */ (function (_super) {
            ...
            case this.COMMAND_ERASE:
                switch (value) {
                    ...
                    case this.COMMAND_ERASE_SECTOR:
                        if ((offset & 0x0fff) == 0) {
                            for (var i_1 = offset; i_1 < offset + 0x1000; i_1 += 4) {
                                this.bank.setInt32(i_1, -1);
                            }
                        }
                        break;
                }
...
var EEPROMSavedata = /** @class */ (function (_super) {
    ...
    EEPROMSavedata.prototype.loadU16 = function (offset) {
        ...
        if (this.readBitsRemaining < 64) {
            ...
            var data = this.view.getUint8((this.readAddress + step) >> 3) >>
                (0x7 - (step & 0x7));
