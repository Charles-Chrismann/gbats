...
exports.GameBoyAdvanceRenderProxy = exports.MemoryProxy = void 0;
var util_js_1 = require("../util.js");
var node_worker_threads_1 = require("node:worker_threads");
var mmu_js_1 = require("../mmu.js");
var MemoryProxy = /** @class */ (function () {
    function MemoryProxy(owner, size, blockSize) {
        ...
        if (blockSize) {
            for (var i = 0; i < (size >> blockSize); ++i) {
                this.blocks.push(new mmu_js_1.MemoryView(new ArrayBuffer(1 << blockSize)));
            }
        }
        else {
            this.blockSize = 31;
            this.mask = -1;
            this.blocks[0] = new mmu_js_1.MemoryView(new ArrayBuffer(size));
        }
    }
    ...
    MemoryProxy.prototype.replace = function (buffer) {
        for (var i = 0; i < this.blocks.length; ++i) {
            this.blocks[i] = new mmu_js_1.MemoryView(buffer.slice(i << this.blockSize, (i << this.blockSize) + this.blocks[i].buffer.byteLength));
        }
    };
...
;
var GameBoyAdvanceRenderProxy = /** @class */ (function () {
    function GameBoyAdvanceRenderProxy() {
        this.worker = new node_worker_threads_1.Worker('./gba/video/worker.js');
        this.currentFrame = 0;
        this.delay = 0;
    ...
    GameBoyAdvanceRenderProxy.prototype.freeze = function (encodeBase64) {
        return {
            'palette': util_js_1.Serializer.prefix(this.palette.combine()),
            'vram': util_js_1.Serializer.prefix(this.vram.combine()),
            'oam': util_js_1.Serializer.prefix(this.oam.combine())
        };
    };
    ...
    return GameBoyAdvanceRenderProxy;
}());
exports.GameBoyAdvanceRenderProxy = GameBoyAdvanceRenderProxy;
;
