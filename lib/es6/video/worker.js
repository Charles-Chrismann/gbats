...
var software_js_1 = require("./software.js");
var node_worker_threads_1 = require("node:worker_threads");
var video = new software_js_1.GameBoyAdvanceSoftwareRenderer();
var proxyBacking = null;
var currentFrame = 0;
function finishDraw(pixelData) {
    node_worker_threads_1.parentPort.postMessage({ type: 'finish', backing: pixelData, frame: currentFrame });
}
...
var handlers = {
    ...
    finish: function (data) {
        ...
        finishDraw(node_worker_threads_1.parentPort, video.pixelData);
    },
};
node_worker_threads_1.parentPort.onmessage = function (message) {
