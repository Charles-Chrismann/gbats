...
exports.GameBoyAdvanceMMU = exports.BadMemory = exports.BIOSView = exports.ROMView = exports.MemoryBlock = exports.MemoryView = void 0;
...
var ROMView = /** @class */ (function (_super) {
...
var BIOSView = /** @class */ (function (_super) {
...
var BadMemory = /** @class */ (function () {
    ...
    BadMemory.prototype.load8 = function (offset) {
        return this.mmu.load8(this.cpu.gprs[this.cpu.PC] -
            this.cpu.instructionWidth +
            (offset & 0x3));
    };
    BadMemory.prototype.load16 = function (offset) {
        return this.mmu.load16(this.cpu.gprs[this.cpu.PC] -
            this.cpu.instructionWidth +
            (offset & 0x2));
    };
    BadMemory.prototype.loadU8 = function (offset) {
        return this.mmu.loadU8(this.cpu.gprs[this.cpu.PC] -
            this.cpu.instructionWidth +
            (offset & 0x3));
    };
    BadMemory.prototype.loadU16 = function (offset) {
        return this.mmu.loadU16(this.cpu.gprs[this.cpu.PC] -
            this.cpu.instructionWidth +
            (offset & 0x2));
    };
...
exports.BadMemory = BadMemory;
var GameBoyAdvanceMMU = /** @class */ (function () {
    ...
    GameBoyAdvanceMMU.prototype.freeze = function () {
        return {
            ram: util_1.Serializer.prefix(this.memory[this.REGION_WORKING_RAM].buffer),
            iram: util_1.Serializer.prefix(this.memory[this.REGION_WORKING_IRAM].buffer)
        };
    };
        ...
        if (process) {
            ...
            if (terminal) {
                ...
                switch (state) {
                    case "FLASH_V":
                    case "FLASH512_V":
                        this.save = this.memory[this.REGION_CART_SRAM] = new savedata_1.FlashSavedata(this.SIZE_CART_FLASH512);
                        break;
                    case "FLASH1M_V":
                        this.save = this.memory[this.REGION_CART_SRAM] = new savedata_1.FlashSavedata(this.SIZE_CART_FLASH1M);
                        break;
                    case "SRAM_V":
                        this.save = this.memory[this.REGION_CART_SRAM] = new savedata_1.SRAMSavedata(this.SIZE_CART_SRAM);
                        break;
                    case "EEPROM_V":
                        this.save = this.memory[this.REGION_CART2 + 1] = new savedata_1.EEPROMSavedata(this.SIZE_CART_EEPROM, this);
                        break;
                }
            }
            if (!this.save) {
    ...
    GameBoyAdvanceMMU.prototype.allocGPIO = function (rom) {
        return new gpio_1.GameBoyAdvanceGPIO(this.core, rom);
    };
