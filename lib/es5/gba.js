...
exports.GameBoyAdvance = void 0;
var core_1 = require("./core");
var mmu_1 = require("./mmu");
var irq_1 = require("./irq");
var io_1 = require("./io");
var audio_1 = require("./audio");
var video_1 = require("./video");
var keypad_1 = require("./keypad");
var sio_1 = require("./sio");
var fs = require("fs");
var GameBoyAdvance = /** @class */ (function () {
    function GameBoyAdvance() {
        ...
        this.rom = null;
        this.cpu = new core_1.ARMCore();
        this.mmu = new mmu_1.GameBoyAdvanceMMU();
        this.irq = new irq_1.GameBoyAdvanceInterruptHandler();
        this.io = new io_1.GameBoyAdvanceIO();
        this.audio = new audio_1.GameBoyAdvanceAudio();
        this.video = new video_1.GameBoyAdvanceVideo();
        this.keypad = new keypad_1.GameBoyAdvanceKeypad();
        this.sio = new sio_1.GameBoyAdvanceSIO();
    ...
    GameBoyAdvance.prototype.loadRomFromFile = function (romFile, callback) {
        var self = this;
        var rom = fs.readFileSync(romFile);
        var arrBuffer = rom.buffer.slice(rom.byteOffset, rom.byteOffset + rom.byteLength);
        var result = self.setRom(arrBuffer);
        if (callback) {
            callback(result ? null : new Error('Invalid ROM'), result);
        }
    };
    GameBoyAdvance.prototype.loadRom = function (rom) {
        var arrBuffer = rom.buffer.slice(rom.byteOffset, rom.byteOffset + rom.byteLength);
        var result = this.setRom(arrBuffer);
    };
...
exports.GameBoyAdvance = GameBoyAdvance;
