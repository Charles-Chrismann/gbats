...
exports.GameBoyAdvanceSIO = void 0;
var util_1 = require("./util");
var GameBoyAdvanceSIO = /** @class */ (function () {
    ...
    GameBoyAdvanceSIO.prototype.setMode = function (mode) {
        ...
        this.mode = mode;
        this.core.INFO("Setting SIO mode to " + (0, util_1.hex)(mode, 1));
    };
...
exports.GameBoyAdvanceSIO = GameBoyAdvanceSIO;
