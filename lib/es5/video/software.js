...
exports.GameBoyAdvanceSoftwareRenderer = exports.GameBoyAdvanceOBJLayer = exports.GameBoyAdvanceOBJ = exports.GameBoyAdvancePalette = exports.GameBoyAdvanceOAM = exports.GameBoyAdvanceVRAM = exports.MemoryAligned16 = void 0;
var MemoryAligned16 = /** @class */ (function () {
...
exports.MemoryAligned16 = MemoryAligned16;
;
var GameBoyAdvanceVRAM = /** @class */ (function (_super) {
...
exports.GameBoyAdvanceVRAM = GameBoyAdvanceVRAM;
;
var GameBoyAdvanceOAM = /** @class */ (function (_super) {
...
exports.GameBoyAdvanceOAM = GameBoyAdvanceOAM;
;
// GameBoyAdvanceOAM.prototype = Object.create(MemoryAligned16.prototype);
var GameBoyAdvancePalette = /** @class */ (function () {
...
exports.GameBoyAdvanceOBJ = GameBoyAdvanceOBJ;
var GameBoyAdvanceOBJLayer = /** @class */ (function () {
...
exports.GameBoyAdvanceOBJLayer = GameBoyAdvanceOBJLayer;
;
var GameBoyAdvanceSoftwareRenderer = /** @class */ (function () {
    ...
    GameBoyAdvanceSoftwareRenderer.prototype.freeze = function (arg0) {
        return {
            'palette': JSON.stringify({
                colors: this.palette.colors,
                adjustedColors: this.palette.adjustedColors,
                passthroughColors: this.palette.passthroughColors,
                blendY: this.palette.blendY,
            }),
            'vram': JSON.stringify({
                buffer: Array.from(this.vram.buffer),
                vram: Array.from(this.vram.vram),
            }),
            'oam': JSON.stringify({
                buffer: Array.from(this.oam.buffer),
                oam: Array.from(this.oam.oam),
                scalerot: this.oam.scalerot
            })
        };
    };
    GameBoyAdvanceSoftwareRenderer.prototype.defrost = function (frost, arg1) {
        var frostTheTrue = {
            palette: JSON.parse(frost.palette),
            vram: JSON.parse(frost.vram),
            oam: JSON.parse(frost.oam),
        };
        this.palette.colors = frostTheTrue.palette.colors;
        this.palette.adjustedColors = frostTheTrue.palette.adjustedColors;
        this.palette.passthroughColors = frostTheTrue.palette.passthroughColors;
        this.palette.blendY = frostTheTrue.palette.blendY;
        this.vram.buffer = Uint16Array.from(frostTheTrue.vram.buffer);
        this.vram.vram = Uint16Array.from(frostTheTrue.vram.vram);
        this.oam.buffer = Uint16Array.from(frostTheTrue.oam.buffer);
        this.oam.oam = Uint16Array.from(frostTheTrue.oam.oam);
        this.oam.scalerot = frostTheTrue.oam.scalerot;
    };
